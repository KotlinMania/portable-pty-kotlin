...
This file is the quick-reference operating contract for portable-pty-kotlin. The longer
...
portable-pty-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`portable-pty`](https://crates.io/crates/portable-pty). Upstream Rust is the behavioral oracle while the
