...
kotlin {
    ...
    val xcf = XCFramework("PortablePty")

    macosArm64 {
        binaries.framework { baseName = "PortablePty"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "PortablePty"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "PortablePty"
        flattenPackage = "io.github.kotlinmania.portablepty"
    }

    android {
        namespace = "io.github.kotlinmania.portablepty"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "portable-pty-kotlin", version.toString())

    pom {
        name.set("portable-pty-kotlin")
        description.set("Kotlin Multiplatform port of wezterm/wezterm - Cross platform pty interface")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/portable-pty-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/portable-pty-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/portable-pty-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/portable-pty-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assemblePortablePtyXCFramework",
    "assemblePortablePtyDebugXCFramework",
    "assemblePortablePtyReleaseXCFramework",
    "assembleDebugIosFatFrameworkForPortablePtyXCFramework",
    "assembleReleaseIosFatFrameworkForPortablePtyXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForPortablePtyXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForPortablePtyXCFramework",
    "assembleDebugMacosFatFrameworkForPortablePtyXCFramework",
    "assembleReleaseMacosFatFrameworkForPortablePtyXCFramework",
    "assembleDebugTvosFatFrameworkForPortablePtyXCFramework",
    "assembleReleaseTvosFatFrameworkForPortablePtyXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForPortablePtyXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForPortablePtyXCFramework",
    "assembleDebugWatchosFatFrameworkForPortablePtyXCFramework",
    "assembleReleaseWatchosFatFrameworkForPortablePtyXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForPortablePtyXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForPortablePtyXCFramework",
