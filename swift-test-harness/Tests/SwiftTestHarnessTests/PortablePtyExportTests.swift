...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `PortablePty.swiftmodule/`
...
//      `import PortablePty` above would fail at compile time.
//
//   2. The static archive `libPortablePty.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "PortablePty" }` and
//      `flattenPackage = "io.github.kotlinmania.portablepty"` configuration in
...
//      via the `PortablePtyLibrary` product.
//
...
final class PortablePtyExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "PortablePty swift module imported cleanly")
    }
}
